...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime11.jsx)(SvgIcon_default, _extends({
...
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React80.useState(!requestedEnter);
  React80.useEffect(() => {
    if (requestedEnter) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3E7JVAVU.js.map
